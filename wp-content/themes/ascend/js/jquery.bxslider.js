  ...
  jQuery.fn.bxSlider = function(options) {
    ...
    var loadElements = function(selector, callback) {
      ...
      selector.find('img:not([src=""]), iframe').each(function() {
        jQuery(this).one('load error', function() {
          ...
          if (this.complete || this.src == '') { jQuery(this).trigger('load'); }
        });
      });
    };
    ...
    var initAuto = function() {
      ...
      // if autoDelay was not supplied, start the auto show normally
        ...
        jQuery(window).focus(windowFocusHandler).blur(windowBlurHandler);
      }
    ...
    el.destroySlider = function() {
	  ...
	  jQuery(window).off('blur', windowBlurHandler).off('focus', windowFocusHandler);
    };
