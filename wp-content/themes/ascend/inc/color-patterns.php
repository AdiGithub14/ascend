 ...
 */
function ascend_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Ascend default saturation level.
	 *
	 * @since Ascend 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'ascend_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.ascend-front-page) .entry-title,
...
.colors-custom .ascend-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.ascend-front-page .panel-content .recent-posts article,
...
.colors-custom.ascend-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Ascend custom colors CSS.
	 *
	 * @since Ascend 1.0
	 *
	 ...
	 */
	return apply_filters( 'ascend_custom_colors_css', $css, $hue, $saturation );
}
