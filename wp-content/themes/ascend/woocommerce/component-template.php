 ...
 * Description: The Component Part in side the product page design
 * Version : 1.0
 * 
 * */
?>
...
foreach($recent_posts as $recent_posts)
{
	...
	$com_name =  get_post_meta($productId,$bobc,true);
	 ...
	 if($com_name !="Null Data")
	 {
		 ...
		 $page = get_page_by_title($com_name, OBJECT, 'component');
			$com_post_id = $page->ID;
          ...
          <div class="row clearfix">
              <div class="right_content">
                <div class="img_outer_box">
                   <div class="img_inner_box getPopup" id="img_component-<?php echo $com_post_id;?>">
            ...
            <div class="productHeading full_width_underline"> 
             <h4 class="head_four left_align_head content_width_underline getPopup" id="component-<?php echo $com_post_id;?>"><?php the_title();?></h4>
           </div>
            <p><?php the_content();?></p>
              </div>
          </div>
